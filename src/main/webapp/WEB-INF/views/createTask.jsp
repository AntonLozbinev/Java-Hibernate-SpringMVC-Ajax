...
<div class="container">
    ...
    <div class="content">
        ...
        <c:url value="/task/create" var="userActionUrl"/>
        <div class="cont_body">
            <sf:form modelAttribute="taskModel" action="${userActionUrl}" method="post">
                <table>
                    <caption><h4>Новое задание:</h4></caption>
                    <tr>
                        <td>
                            Имя:
                        </td>
                    ...
                    <tr>
                        ...
                        <td align="right">
                            <sf:radiobutton path="type" value="read" id="read" checked="true" onclick="getRightExecutors('read')"/> Прочитать
                    ...
                    <tr>
                        ...
                        <td>
                            <sf:input path="priority" type="range" min="1" max="10" value="1" oninput="changePrior()"/>
                    ...
                    <tr>
                        ...
                        <td>
                            <select size="1" id="executor" name="executorId">
                            </select>
                            <script>
                                getRightExecutors('read');
                            </script>
                        </td>
                    </tr>
                    <tr align="center">
